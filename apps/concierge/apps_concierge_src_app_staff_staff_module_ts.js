...
class StaffDetailsComponent {
  constructor(_state) {
    var _this = this;
    this._state = _state;
    this.checkin = /*#__PURE__*/(0,C_Users_PCS_Desktop_placeOS_user_interfaces_develop_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      _this.loading = true;
    ...
    this.checkout = /*#__PURE__*/(0,C_Users_PCS_Desktop_placeOS_user_interfaces_develop_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      _this.loading = true;
