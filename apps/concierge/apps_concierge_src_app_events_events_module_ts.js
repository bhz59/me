  ...
  save() {
    ...
    return (0,C_Users_PCS_Desktop_placeOS_user_interfaces_develop_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const res = yield _this2._form_state.postForm().catch( /*#__PURE__*/function () {
        var _ref2 = (0,C_Users_PCS_Desktop_placeOS_user_interfaces_develop_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (e) {
          (0,_placeos_common__WEBPACK_IMPORTED_MODULE_2__.notifyError)(e);
...
class EventStateService extends _placeos_common__WEBPACK_IMPORTED_MODULE_2__.AsyncHandler {
  ...
  viewEvent(event) {
    ...
    this.subscription(`remove:${event.id}`, ref.componentInstance.remove.subscribe( /*#__PURE__*/(0,C_Users_PCS_Desktop_placeOS_user_interfaces_develop_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
...
class EventsListComponent extends _placeos_common__WEBPACK_IMPORTED_MODULE_1__.AsyncHandler {
  ...
  _generatePeriods() {
    var _this = this;
    this.timeout('generate_periods', /*#__PURE__*/(0,C_Users_PCS_Desktop_placeOS_user_interfaces_develop_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const periods = [];
