...
class AssetBulkFormComponent extends _placeos_common__WEBPACK_IMPORTED_MODULE_3__.AsyncHandler {
  ...
  ngOnInit() {
    ...
    this.subscription('route.query', this._route.queryParamMap.subscribe( /*#__PURE__*/function () {
      var _ref = (0,C_Users_PCS_Desktop_placeOS_user_interfaces_develop_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (params) {
        if (params.get('id')) {
...
class AssetCategoryManagementModalComponent {
  constructor(_data, _dialog_ref) {
    ...
    this.remove = /*#__PURE__*/function () {
      var _ref = (0,C_Users_PCS_Desktop_placeOS_user_interfaces_develop_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (category) {
  ...
  setRoomAvailability() {
    ...
    return (0,C_Users_PCS_Desktop_placeOS_user_interfaces_develop_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this.subscription('room-availability', ref.componentInstance.change.subscribe( /*#__PURE__*/function () {
        var _ref = (0,C_Users_PCS_Desktop_placeOS_user_interfaces_develop_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (list) {
...
class AssetPurchaseOrderFormComponent extends _placeos_common__WEBPACK_IMPORTED_MODULE_3__.AsyncHandler {
  ...
  constructor(_state, _route, _router, _org) {
    ...
    this.asset_list = (0,rxjs__WEBPACK_IMPORTED_MODULE_10__.combineLatest)([this._id, this._org.active_building]).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_11__.filter)(([_, bld]) => !!_ && !!bld), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_12__.switchMap)(([id]) => (0,_placeos_assets__WEBPACK_IMPORTED_MODULE_2__.queryAssets)({
      ...
      var _ref = (0,C_Users_PCS_Desktop_placeOS_user_interfaces_develop_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (asset_list) {
  ...
  ngOnInit() {
    var _this2 = this;
    this.subscription('route.query', this._route.queryParamMap.subscribe( /*#__PURE__*/function () {
      var _ref2 = (0,C_Users_PCS_Desktop_placeOS_user_interfaces_develop_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (params) {
        if (params.get('id')) {
