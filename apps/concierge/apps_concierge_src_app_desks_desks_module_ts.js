...
class DeskBookingsComponent {
  ...
  constructor(_state, _settings) {
    ...
    this.checkin = (d, s) => this.runMethod('checkin', /*#__PURE__*/(0,C_Users_PCS_Desktop_placeOS_user_interfaces_develop_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      yield _this._state.checkinDesk(d, s);
      d.checked_in = s ?? true;
    }));
    this.approve = d => this.runMethod('approve', /*#__PURE__*/(0,C_Users_PCS_Desktop_placeOS_user_interfaces_develop_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      return _this._state.approveDesk(d);
    }));
    this.reject = d => this.runMethod('reject', /*#__PURE__*/(0,C_Users_PCS_Desktop_placeOS_user_interfaces_develop_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
  ...
  ngOnInit() {
    ...
    return (0,C_Users_PCS_Desktop_placeOS_user_interfaces_develop_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this.subscription('levels', _this._org.active_levels.subscribe( /*#__PURE__*/function () {
        var _ref = (0,C_Users_PCS_Desktop_placeOS_user_interfaces_develop_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (levels) {
          const filters = yield _this.filters.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_12__.take)(1)).toPromise();
  ...
  _checkManage() {
    ...
    if (this.manage) {
      this.subscription('zone-changes', this._org.active_levels.subscribe( /*#__PURE__*/function () {
        var _ref = (0,C_Users_PCS_Desktop_placeOS_user_interfaces_develop_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (lvls) {
