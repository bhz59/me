...
class SignageStateService {
  ...
  previewFileMedia(media) {
    ...
    ref.afterClosed().subscribe(() => URL.revokeObjectURL(url));
    ref.componentInstance.save.subscribe( /*#__PURE__*/(0,C_Users_PCS_Desktop_placeOS_user_interfaces_develop_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
