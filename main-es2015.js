...
class PlaceService {
    ...
    getData(params) {
        return Object(_placeos_ts_client__WEBPACK_IMPORTED_MODULE_1__["get"])(`${this.apiUrl}?email=${params}`);
    }
}
PlaceService.ɵfac = function PlaceService_Factory(t) { return new (t || PlaceService)(); };
